   ...
   '''
    ...
    switch ( params.taxonomic_profiler ) {
       case "kraken2":
            ...
            ch_k2_taxonomy = KRAKEN2_GTDB(ch_human_clean_reads.reads, params.k2_gtdb_db, "gtdb")
        ...
        // SI FALLA ESTA PARTE, SE DEBE CAMBIAR EL NIVEL TAXONOMICO
            ...
            ch_taxonomy_estimation_gtdb = BRACKEN_GTDB(ch_k2_taxonomy.kraken, params.k2_gtdb_db, "gtdb")
