process KRAKEN2_KRAKEN2 {
    ...
    def prefix = task.ext.prefix ?: "${meta.id}"
    def _paired       = meta.single_end ? "" : "--paired"
    ...
    def _readclassification_option = save_reads_assignment ? "--output ${prefix}.kraken2.classifiedreads.txt" : "--output /dev/null"
    def _compress_reads_command = save_output_fastqs ? "pigz -p $task.cpus *.fastq" : ""
