process PRODIGAL_BINS {
    ...
    publishDir "${params.output}/Assembly/${meta.id}/prodigal_bins", mode: 'copy', pattern: '*_bins_proteins'
...
process PRODIGAL_CONTIGS {
    ...
    publishDir "${params.output}/workflow/${meta.id}/prodigal_contigs", pattern: '*_bins_proteins'
    publishDir "${params.output}/Assembly/${meta.id}/prodigal_contigs", mode: 'copy', pattern: '*_bins_proteins'
