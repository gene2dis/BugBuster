...
process BBMAP_COASSEMBLY {
    ...
    publishDir "${params.output}/coassembly_and_bins/contigs", mode: 'copy', pattern: '*_contig.stats'
    publishDir "${params.output}/coassembly_and_bins/contigs", mode: 'copy', pattern: '*_filtered_contigs.fa'
