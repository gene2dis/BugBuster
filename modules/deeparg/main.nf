...
process DEEPARG_CONTIGS {
    ...
    publishDir = [path: { "${params.output}/workflow/${meta.id}/deeparg_contigs" }, pattern: "*.out.mapping.ARG"]
    publishDir = [path: { "${params.output}/ARG_prediction/Contig_level/Samples/${meta.id}/DeepARG" }, mode: 'copy', pattern: "*.out.mapping.ARG"]
